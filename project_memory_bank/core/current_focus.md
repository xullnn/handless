...
- Simple deterministic numeric ITN is the validated first-line approach for simple final-output numeric formatting. ASR numeric prompting remains non-default; numeric ITN stays local, configurable, and final-output only unless a separate partial-display feature is validated.
