...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| mimo-v2.5-asr-mlx | file_level | 1 | 0.0000 | 0.0000 | 6.6164 | n/a | 41638.8 | 1.0000 |
| mimo-v2.5-asr-mlx | segmented | 1 | n/a | n/a | n/a | n/a | n/a | n/a |
| qwen3-asr-0.6b-mlx-8bit | file_level | 1 | 0.1053 | 0.1053 | 0.0310 | n/a | 195.2 | 0.9474 |
| qwen3-asr-0.6b-mlx-8bit | segmented | 1 | 0.1053 | 0.1053 | 1.2626 | 1087.7 | 154.6 | 0.9474 |
| qwen3-asr-1.7b-mlx-8bit | file_level | 1 | 0.1053 | 0.1053 | 0.0456 | n/a | 287.3 | 0.9474 |
| qwen3-asr-1.7b-mlx-8bit | segmented | 1 | 0.1053 | 0.1053 | 1.3632 | 1129.3 | 267.1 | 0.9474 |

## 总览：Deduplicated Audio Rollup

| 模型 | 模式 | unique-like cases | CER | WER | RTF | final latency ms | final coverage |
|---|---|---:|---:|---:|---:|---:|---:|
| mimo-v2.5-asr-mlx | file_level | 1 | 0.0000 | 0.0000 | 6.6164 | 41638.8 | 1.0000 |
| mimo-v2.5-asr-mlx | segmented | 1 | n/a | n/a | n/a | n/a | n/a |
| qwen3-asr-0.6b-mlx-8bit | file_level | 1 | 0.1053 | 0.1053 | 0.0310 | 195.2 | 0.9474 |
| qwen3-asr-0.6b-mlx-8bit | segmented | 1 | 0.1053 | 0.1053 | 1.2626 | 154.6 | 0.9474 |
| qwen3-asr-1.7b-mlx-8bit | file_level | 1 | 0.1053 | 0.1053 | 0.0456 | 287.3 | 0.9474 |
| qwen3-asr-1.7b-mlx-8bit | segmented | 1 | 0.1053 | 0.1053 | 1.3632 | 267.1 | 0.9474 |

## 分 Suite 结果

| 模型 | 模式 | suite | cases | CER | WER | RTF | peak RSS MB | peak CPU % | numeric pass |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| qwen3-asr-0.6b-mlx-8bit | file_level | smoke | 1 | 0.1053 | 0.1053 | 0.0310 | 90.8 | 64.0 | n/a |
| qwen3-asr-1.7b-mlx-8bit | file_level | smoke | 1 | 0.1053 | 0.1053 | 0.0456 | 2065.1 | 86.0 | n/a |
| mimo-v2.5-asr-mlx | file_level | smoke | 1 | 0.0000 | 0.0000 | 6.6164 | 7107.7 | 87.1 | n/a |
| qwen3-asr-0.6b-mlx-8bit | segmented | smoke | 1 | 0.1053 | 0.1053 | 1.2626 | 1156.5 | 77.2 | n/a |
| qwen3-asr-1.7b-mlx-8bit | segmented | smoke | 1 | 0.1053 | 0.1053 | 1.3632 | 2553.4 | 120.0 | n/a |
